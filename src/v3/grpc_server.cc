...
Status
GrpcServer::AsyncLearn(const vpaxos_rpc::Learn &request, const std::string &address, LearnFinishFunc cb) {
...
Status
GrpcServer::AsyncPing(const vpaxos_rpc::Ping &request, const std::string &address, PingFinishFunc cb) {
    std::shared_ptr<grpc::Channel> channel = grpc::CreateChannel(address, grpc::InsecureChannelCredentials());
    std::unique_ptr<vpaxos_rpc::VPaxos::Stub> stub = vpaxos_rpc::VPaxos::NewStub(channel);
    // optimizing by memory pool
...
Status
GrpcServer::AsyncPrepare(const vpaxos_rpc::Prepare &request, const std::string &address, PrepareFinishFunc cb) {
    std::shared_ptr<grpc::Channel> channel = grpc::CreateChannel(address, grpc::InsecureChannelCredentials());
    std::unique_ptr<vpaxos_rpc::VPaxos::Stub> stub = vpaxos_rpc::VPaxos::NewStub(channel);
    // optimizing by memory pool
...
Status
GrpcServer::AsyncAccept(const vpaxos_rpc::Accept &request, const std::string &address, AcceptFinishFunc cb) {
    std::shared_ptr<grpc::Channel> channel = grpc::CreateChannel(address, grpc::InsecureChannelCredentials());
    std::unique_ptr<vpaxos_rpc::VPaxos::Stub> stub = vpaxos_rpc::VPaxos::NewStub(channel);
    // optimizing by memory pool
